...
public class Help extends Command{
	...
	public void doCommand(BaseBot bot, Message message, String[] params) {
		...
		if (params != null && params.length > 0) {
			...
			reply = String.format("%s, reportando!\nEu sou um bot de testes. Meu código foi muito mal feito, mas com algumas silver tapes, tudo vai ficar em seu devido lugar. De qualquer forma, aqui estão meus comandos:\n", message.getAuthor().getAsMention());
			reply += "---------------------\n";
